...
const ProductDetails = () => {
    ...
    const { images, title, info, category, finalPrice, originalPrice, ratings, rateCount, location } = product;
                ...
                <div className="container">
                    <div className="wrapper prod_details_wrapper">
                        ...
                        <div className="prod_details_right_col">
                            ...
                            <a href={location} target='_blank'><h5 className="prod_details_location">Location</h5></a>
